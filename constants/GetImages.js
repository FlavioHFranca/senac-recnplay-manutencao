class GetImages {
  getHardwareImages() {
    const hardwareImageArray = Array(
      ...
      {
        code: 109,
        name: "network_card_section.png",
        title: "Placa de rede",
        alt: "cartão de placa de rede.",
        info: {
          name: "network_card_tooltip.png",
          description: "Uma placa de rede é um componente de hardware que permite a conexão de dispositivos a uma rede de computadores, permitindo a comunicação e transferência de dados.",
          complement: "Clique para substituir a placa de rede do computador por outra."
        }
      },
      {
        code: 110,
